---
title: "SARS-CoV-2 Variant Nowcast Hub weekly report"
...
target_data <- arrow::read_parquet(target_data_filename) |> 
  ...
  dplyr::filter(date >= this_ref_date - 75, ## fixing min date for plotting
...
```{r forecast-function, eval=FALSE}
...
bscols(
  ...
  ggplotly(
    ggplot() +
      ...
      #             se=FALSE, method="gam") +
      # geom_vline(xintercept=this_ref_date, linetype = 2) +
